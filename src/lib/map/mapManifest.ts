  ...
  maps: [
    {
      ...
      pois: [
        { id: 'player_home', kind: 'house', name: 'Your House', x: 400, y: 210, interact: 'talk', labelAnchor: 'below', drawLayer: 2, noStack: true, line: 'Home sweet home. Safe walls of Town 1.' },
        { id: 'npc_stella', kind: 'npc', name: 'Stella', x: 440, y: 280, interact: 'talk', labelAnchor: 'below', drawLayer: 2, noStack: true },
        { id: 'star_mart', kind: 'market', name: 'Star Mart', x: 280, y: 230, interact: 'shop', labelAnchor: 'below', drawLayer: 2, noStack: true },
        { id: 'star_scrolls', kind: 'market', name: 'Scroll Stall', x: 240, y: 280, interact: 'shop', labelAnchor: 'below', drawLayer: 2, noStack: true },
        { id: 'star_inn', kind: 'hotel', name: 'Softcloud Inn', x: 520, y: 230, interact: 'rest', labelAnchor: 'below', drawLayer: 2, noStack: true },
        { id: 'star_heal', kind: 'landmark', name: 'Star Spring', x: 280, y: 380, interact: 'heal', labelAnchor: 'below', drawLayer: 2, noStack: true },
        { id: 'star_golf', kind: 'landmark', name: 'Star Golf', x: 520, y: 390, interact: 'golf', labelAnchor: 'below', drawLayer: 2, noStack: true },
      ],
