...
const JOBS: Params[] = [
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: '', stat_bonus: 'spd+6,atk+5', description: 'นักธนูเริ่มต้น',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: '', stat_bonus: 'spd+8,atk+3', description: 'นักดาบคู่ผู้รวดเร็ว',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'spd+12,atk+10', description: 'นักล่าที่คล่องตัว ยิงเร็วหลายดอก',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'atk+18,spd+3', description: 'มือปืนระยะไกล พลังต่อนัดสูง',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'spd+14,atk+12', description: 'เงามืด สังหารจากจุดบอด',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'atk+16,spd+6', description: 'นักดาบเดี่ยว แม่นและฉับไว',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'atk+22,spd+5', description: 'พลหอกพุ่งทะลุแนว',
  ...
  },
  {
    ...
    is_hidden: '0', unlock_condition: 'level:20,mastery:5',
    stat_bonus: 'mp+35,spd+6', description: 'นักเพลงเสริมพลังทีม',
  ...
  },
  {
    ...
    stat_bonus: 'atk+35,spd+8', description: 'อาชีพลับแห่งเผ่า Vorpal — ปลดเมื่อได้รับความไว้วางใจ',
